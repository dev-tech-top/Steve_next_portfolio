    ...
    return (
        <LazyMotion features={domAnimation}>
            <div className="section">
                ...
                <div className="flex flex-col lg:flex-row gap-10 justify-center items-center w-full max-w-5xl mx-auto">
                    {/* Contact Form Card */}
                                        ...
                                        <motion.div custom="bottom" variants={{ hidden: { opacity: 0, y: 50 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, ease: 'easeOut' } } }}>
                                            <div className="flex justify-end">
                                                <motion.button
                                                    ...
                                                    className={`px-6 py-2 font-semibold rounded-lg shadow transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 ${loading ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-primary text-black hover:bg-primary-dark hover:text-white'}`}
                                                >
                                                    <span>Send</span>
                                                </motion.button>
                                            </div>
